...
$db_host = "sql306.infinityfree.com"; // Sesuaikan dengan Host Database InfinityFree Anda
$db_name = "NamaDatabase";     // Sesuaikan dengan Nama Database Anda
$db_user = "User";              // Sesuaikan dengan Username Database Anda
$db_pass = "Password";                 // Sesuaikan dengan Sandi Database Anda

// --- KONFIGURASI KEY GEMINI AI ---
$gemini_api_key = getenv("GEMINI_API_KEY") ?: "MASUKKAN_API_KEY_GEMINI_ANDA_DISINI";

// --- KONFIGURASI KEY GROQ AI ---
$groq_api_key = getenv("GROQ_API_KEY") ?: "Masukkan_API_Key_Groq_Anda_Disini";
